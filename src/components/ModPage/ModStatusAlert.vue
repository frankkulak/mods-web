    ...
    export default {
        ...
        computed: {
            ...
            alertContent: function () {
                ...
                else if (this.stageIs(wip)) return `This mod is a work-in-progress, which means it is not yet available for download. Please check back later if you are interested!`;
