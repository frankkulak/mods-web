        ...
        <b-container class="py-5" fluid>
            ...
            <b-row id="patreon-download" class="mt-5 mx-0 px-3 py-4" align-v="center" v-if="showPatreon">
                <b-col cols="12" md="8" class="my-2">
                    ...
                    <div class="ml-2">
                        <p class="mt-2">Enjoying {{ mod.name }}? If you're willing and able to support me on Patreon, it
                            would be greatly appreciated. Thank you for your support!</p>
                    </div>
                </b-col>
...
export default {
    ...
    computed: {
        ...
        showPatreon: function () {
            const devStage = this.mod.developmentStage;
            const {adopted, wip} = DataEnums.developmentStage;
            return devStage !== adopted && devStage !== wip;
        },
        hasImages: function () {
